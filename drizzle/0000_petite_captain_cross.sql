...
CREATE TABLE IF NOT EXISTS "commissions" (
	...
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "commissions_uuid_unique" UNIQUE("uuid")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "negotiation_gates" (
	"id" serial PRIMARY KEY NOT NULL,
	"uuid" uuid DEFAULT gen_random_uuid() NOT NULL,
	"project_id" integer NOT NULL,
	"is_open" boolean DEFAULT true NOT NULL,
	"deposit_amount" numeric(12, 2) DEFAULT '0.00' NOT NULL,
	"max_negotiators" integer,
	"current_negotiators" integer DEFAULT 0 NOT NULL,
	"requirements" jsonb,
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "negotiation_gates_uuid_unique" UNIQUE("uuid"),
	CONSTRAINT "negotiation_gates_project_id_unique" UNIQUE("project_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "referral_codes" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "referral_codes_uuid_unique" UNIQUE("uuid"),
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "commissions" ADD CONSTRAINT "commissions_wallet_id_wallets_id_fk" FOREIGN KEY ("wallet_id") REFERENCES "public"."wallets"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "negotiation_gates" ADD CONSTRAINT "negotiation_gates_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "referral_codes" ADD CONSTRAINT "referral_codes_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "commissions_user_idx" ON "commissions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "commissions_wallet_idx" ON "commissions" USING btree ("wallet_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "commissions_type_idx" ON "commissions" USING btree ("type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "commissions_source_idx" ON "commissions" USING btree ("source_type","source_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "commissions_status_idx" ON "commissions" USING btree ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "commissions_created_at_idx" ON "commissions" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "negotiation_gates_project_idx" ON "negotiation_gates" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "negotiation_gates_is_open_idx" ON "negotiation_gates" USING btree ("is_open");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "referral_codes_user_idx" ON "referral_codes" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "referral_codes_code_idx" ON "referral_codes" USING btree ("code");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "referral_codes_project_idx" ON "referral_codes" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "referral_codes_status_idx" ON "referral_codes" USING btree ("status");--> statement-breakpoint
