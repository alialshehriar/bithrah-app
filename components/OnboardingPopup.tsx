...
const steps = [
  {
    ...
    description: 'منصة التمويل الجماعي الرائدة في السعودية التي تربط أصحاب الأفكار الإبداعية بالمستثمرين والداعمين لتحويل الأحلام إلى واقع ملموس',
    icon: Sparkles,
  ...
  },
  {
    ...
    description: 'شارك مشروعك، احصل على تقييم ذكي بالذكاء الاصطناعي، اختر باقة التمويل المناسبة، واجذب المستثمرين والداعمين. يمكنك أيضاً التفاوض المباشر مع أصحاب المشاريع',
    icon: Lightbulb,
  ...
  },
  {
    id: 3,
    title: 'انضم للمجتمع',
    description: 'تفاعل مع رواد الأعمال والمستثمرين في مجتمعات متخصصة، شارك في المناقشات، احصل على استشارات، وابنِ شبكة علاقات احترافية قوية',
    icon: Users,
  ...
  },
  {
    id: 4,
    title: 'تنافس واربح',
    description: 'اكسب نقاطاً من خلال نشاطك، ارتقِ في المستويات، احصل على إنجازات، وتصدّر لوحة الصدارة. كلما زاد نشاطك، زادت مكافآتك وفرصك',
    icon: TrendingUp,
